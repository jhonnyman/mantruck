...
export class TruckService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listTruck(observe?: 'body', reportProgress?: boolean): Observable<Array<any>>;
    public listTruck(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<any>>>;
    public listTruck(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<any>>>;
    public listTruck(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Array<any>>('get',`${this.basePath}/trucks`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * 
     * @param body Truck object that needs to be added to the store
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    ...
    /**
     * Updates a truck in the store with form data
     * 
     * @param id 
     * @param name 
     * @param engineHP 
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateTruckWithForm(id: number, name: string, engineHP: string, engineVolume: string, fuel: string, segment: string, colors: Array<string>, truckId: number, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public updateTruckWithForm(id: number, name: string, engineHP: string, engineVolume: string, fuel: string, segment: string, colors: Array<string>, truckId: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public updateTruckWithForm(id: number, name: string, engineHP: string, engineVolume: string, fuel: string, segment: string, colors: Array<string>, truckId: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public updateTruckWithForm(id: number, name: string, engineHP: string, engineVolume: string, fuel: string, segment: string, colors: Array<string>, truckId: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (segment === null || segment === undefined) {
            throw new Error('Required parameter segment was null or undefined when calling updateTruckWithForm.');
        }
        ...
        if (segment !== undefined) {
            formParams = formParams.append('segment', <any>segment) as any || formParams;
        }
        if (colors) {
